    ...
    <div className={`min-h-screen grid grid-cols-1 lg:grid-cols-12 overflow-hidden bg-gray-50/50 dark:bg-dark-950 transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      ...
      <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-16 relative mesh-gradient overflow-hidden">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="space-y-6">
            {[
              { title: "Direct Booking Pipeline", desc: "Connect directly with vetted local landlords near Dhulikhel." },
              { title: "Vetted Safety Criteria", desc: "Every listed house matches our rigorous security standard." },
            ].map((item, idx) => (
              <motion.div 
                key={idx}
                variants={fadeInUp}
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 md:p-16 lg:col-span-7 bg-[#fafbfc] dark:bg-[#070d19] transition-colors duration-300">
        ...
        >
          ...
          >
            <motion.div
              className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-dark-950 dark:bg-primary-600 rounded-xl shadow-md transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${role === "student" ? "left-1" : "left-[50%]"}`}
              layout
              ...
              {[
                ...
                >
                  ...
                  <motion.input
                    ...
                    className={`w-full px-4 py-3.5 bg-gray-50/50 hover:bg-gray-50/80 dark:bg-dark-950 dark:hover:bg-dark-950/80 rounded-2xl border text-sm font-medium tracking-wide outline-none transition-all duration-300 text-black dark:text-white ${focused === field.name
