          ...
          >
            <div className="flex items-center gap-5">
              <motion.div 
                ...
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-teal-500 to-primary-500 flex items-center justify-center text-white text-2xl font-extrabold shadow-lg shadow-teal-500/20"
              >
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  {profile?.verified ? (
                    <motion.span 
                      ...
                      className="text-xs font-bold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/40 px-3 py-1 rounded-full border border-green-100 dark:border-green-900/40 flex items-center gap-1"
                    >
                      ✓ Verified
                    </motion.span>
                  ) : (
            ...
            <h2 className="text-lg font-extrabold text-gray-900 dark:text-white flex items-center gap-2">
              ...
              {pendingBookings.length > 0 && (
                <motion.span
                  ...
                  animate={{ scale: 1 }}
                  transition={{ type: "spring", stiffness: 300 }}
                  className="text-xs font-bold text-white bg-[#FF6B47] px-2.5 py-1 rounded-full"
                >
